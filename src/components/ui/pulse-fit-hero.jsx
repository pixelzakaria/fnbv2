...
export function PulseFitHero({
  ...
  return (
    <section
      className={cn(
        "relative w-full min-h-[100dvh] flex flex-col overflow-hidden",
        className
      )}
      style={{
        background: "transparent", // Let the CSS background shine through
      }}
      role="banner"
    ...
    >
      ...
      {/* Program Cards Carousel (Your Festival Highlights) */}
      {programs.length > 0 && (
        <motion.div
        ...
        >
          {/* Light Gradient Overlays for smooth scroll fading */}
          <div
                ...
                >
                  <span
                    style={{
                      ...
                      fontSize: "10px",
                      fontWeight: 900,
                      color: "#60a5fa", // Lighter blue for dark overlay
                      textTransform: "uppercase",
                      letterSpacing: "0.2em",
                    }}
                  >
